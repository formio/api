const Timestamps = require('../_schemaPartials/Timestamps');
const AccessSchema = require('../_schemaPartials/AccessSchema');
const ExternalIdSchema = require('../_schemaPartials/ExternalIdSchema');
